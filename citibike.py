...
def update_figure(selected_hour):
	...
	pie_plot={
		...
		"layout": go.Layout(title="Top frequent start stations", margin={},
                            legend={"x": 0, "y": 1})
	}
	...
	end_pie_plot={
		"data": [go.Pie(labels=groupendstation.index, values=groupendstation.values,
                        marker={'colors': ['#EF963B', '#C93277', '#349600', '#EF533B', '#57D4F1']}, textinfo='percent')],
		"layout": go.Layout(title="Top frequent end stations", margin={},
                            legend={"x": 0, "y": 1})
	}

	return pie_plot,end_pie_plot,scatter_plot,px.parallel_coordinates(filtered_df)
